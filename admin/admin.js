...
import { initJaime, jaimeEscuchando } from './jaime.js?v=17';
...
async function afterLogin(session) {
    ...
    // Le pasamos el nombre del admin para que salude por su nombre.
    initJaime({ pantalla: 'index', adminNombre: data.nombre || '' });
